      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="relative hidden lg:block lg:p-12">
            <a className="block text-yellow-400" href="#">
            ...
            <h2 className="mt-6 text-1xl font-bold text-white sm:text-3xl md:text-4xl">
              Welcome sur la page de connexion 👾
            </h2>

            <p className="mt-4 leading-relaxed text-white/90">
              Connectez-vous pour accéder à votre espace sécurisé et gérer vos
              dépenses en toute simplicité.
            </p>
          </div>
        </section>

        {/* Partie droite (formulaire Clerk) */}
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl w-full">
            {/* Version mobile */}
            <div className="relative -mt-16 block lg:hidden">
              <a
                className="inline-flex size-16 items-center justify-center rounded-full bg-white text-yellow-400 sm:size-20 shadow-lg"
                href="#"
              >
                <span className="sr-only">Accueil</span>
                <svg
